...
cross_check_cv_and_linkedin_task = Task(
    ...
    description=(
        ...
        "You will make fuzzy matching and try to understand if they are scam or just differently presented. \n\n"
        "If there are significant discrepancies, flag them as potential issues.\n\n"
        "If there are slight discrepancies, mention them as such but mention that it's not a big issue.\n\n"
